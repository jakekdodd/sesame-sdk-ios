...
internal extension UIDevice {
    ...
    static let modelName: String = {
        ...
        func mapToDevice(identifier: String) -> String { // swiftlint:disable:this cyclomatic_complexity function_body_length
            ...
            // Simulator
            case "i386",
                 "x86_64":              return "Simulator \(mapToDevice(identifier: ProcessInfo().environment["SIMULATOR_MODEL_IDENTIFIER"] ?? "iOS"))" //swiftlint:disable:this line_length
